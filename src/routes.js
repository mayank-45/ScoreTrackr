...
const routes = [
  ...
  { path: '/base/volleyball', name: 'Volleyball', element: Volleyball },
  { path: '/base/kabbadi', name: 'Kabbadi', element: Kabbadi },
  { path: '/base/chess', name: 'Chess', element: Chess },
  { path: '/base/tabletennis', name: 'Table_tennis', element: Tabletennis },
